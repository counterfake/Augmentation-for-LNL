...
from PreResNet import ResNet101
...
import dataloader_counterfake as dataloader
from preset_parser import parse_args
...
if __name__ == "__main__":
    ...
    def create_model(devices=[0]):
        model = ResNet101(num_classes=args.num_class)
        model = model.cuda()
